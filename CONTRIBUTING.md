...
APM officially supports Claude Code, Codex CLI, Cursor, GitHub Copilot, Antigravity, OpenCode, and DeepSeek Harness. For other assistants (e.g. Windsurf, Kilo Code, Roo Code), community members may develop and maintain unofficial extensions.
